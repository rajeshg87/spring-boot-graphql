insert into SPEAKER values(1,'@speaker1','speaker 1');
insert into SPEAKER values(2,'@speaker2','speaker 2');
insert into SPEAKER values(3,'@speaker3','speaker 3');
insert into SPEAKER values(4,'@speaker4','speaker 4');
